...
class InternVL3_1B_FeatureExtractor(BaseFeatureExtractor):
    def __init__(self):
        ...
        # self.num_layers = len(self.model.vision_tower.vision_model.encoder.layers)
        # self.num_layers = len(self.model.vision_tower.encoder.layers)
        self.num_layers = len(self.model.vision_tower.encoder.layer)
